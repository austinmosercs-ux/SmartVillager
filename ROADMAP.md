...
| 9 | `feature/day-night-cycle` | Sleep enforcement for all non-Guard villagers; Guard night rotation; no resource gathering runs allowed after dark | In Review |
| 10 | `feature/cleric-healing` | Villager healing triggered by health threshold or NEED_HEALING request; potion brewing subrole; player proximity healing from same supply pool | In Review |
